...
// Salty Rabbit Stew
Cauldron.addFluidTransform(<liquid:salty_rabbit_stew>, <ore:dustSalt>, <liquid:rabbit_stew>, 4, true);
Cauldron.addFluidRecipe(<saltmod:salt_rabbit_stew>, <minecraft:bowl>, <liquid:salty_rabbit_stew>);



// Salty Musrhoom Stew
Cauldron.addFluidTransform(<liquid:salty_mushroom_stew>, <ore:dustSalt>, <liquid:mushroom_stew>, 4, true);
Cauldron.addFluidRecipe(<saltmod:salt_mushroom_stew>, <minecraft:bowl>, <liquid:salty_mushroom_stew>);



// Salty Beetroot Stew
Cauldron.addFluidTransform(<liquid:salty_beetroot_soup>, <ore:dustSalt>, <liquid:beetroot_soup>, 4, true);
Cauldron.addFluidRecipe(<saltmod:salt_beetroot_soup>, <minecraft:bowl>, <liquid:salty_beetroot_soup>);



// Pumpkin Porridge
Cauldron.addFluidTransform(<liquid:pumpkin_soup>, <ore:cropPumpkin>, <liquid:soupstock>, 4, true);
...
// Potato Soup
Cauldron.addFluidTransform(<liquid:potato_soup>, <ore:cropPotato>, <liquid:soupstock>, 4, true);
Cauldron.addFluidRecipe(<harvestcraft:potatosoupitem>, <minecraft:bowl>, <liquid:potato_soup>);



// Carrot Soup
Cauldron.addFluidTransform(<liquid:carrot_soup>, <ore:cropCarrot>, <liquid:soupstock>, 4, true);
Cauldron.addFluidRecipe(<harvestcraft:carrotsoupitem>, <minecraft:bowl>, <liquid:carrot_soup>);



// Potato/Carrot Mixture
Cauldron.addFluidTransform(<liquid:potato_carrot_mixture>, <ore:cropCarrot>, <liquid:potato_soup>, 4, true);
Cauldron.addFluidTransform(<liquid:potato_carrot_mixture>, <ore:cropPotato>, <liquid:carrot_soup>, 4, true);



// Veggie Stew
Cauldron.addFluidTransform(<liquid:vegetable_soup>, <ore:mushroomAny>, <liquid:potato_carrot_mixture>, 4, true);
...
Cauldron.addFluidTransform(<liquid:salty_vegetable_soup>, <ore:dustSalt>, <liquid:vegetable_soup>, 4, true);
...
// Fish soup
Cauldron.addFluidTransform(<liquid:fish_soup>, <ore:salmonRaw>, <liquid:potato_carrot_mixture>, 4, true);
...
// Salty Fish Soup
Cauldron.addFluidTransform(<liquid:salty_fish_soup>, <ore:dustSalt>, <liquid:fish_soup>, 4, true);
...
// Salmon soup
Cauldron.addFluidTransform(<liquid:salmon_soup>, <minecraft:fish:1>, <liquid:potato_carrot_mixture>, 4, true);
...
// Salty Salmon Soup
Cauldron.addFluidTransform(<liquid:salty_salmon_soup>, <ore:dustSalt>, <liquid:salmon_soup>, 4, true);
