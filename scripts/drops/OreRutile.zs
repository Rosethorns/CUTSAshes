...
var clump = <materialpart:rutile:clump>.getItemStack() as IItemStack;
...
clumps.add(Dropt.rule()
    ...
    .addDrop(Dropt.drop()
        ...
        .items([<materialpart:rutile:clump>.getItemStack()], Dropt.range(1))
    )
    .addDrop(Dropt.drop()
        .selector(Dropt.weight(1), "EXCLUDED", 1)
        .items([<materialpart:rutile:clump>.getItemStack()], Dropt.range(0,1))
    )
    .addDrop(Dropt.drop()
